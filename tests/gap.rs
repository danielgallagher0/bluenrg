...
fn set_nondiscoverable() {
    ...
    assert!(sink.wrote(&[1, 0x81, 0xFC, 0]));
}
...
fn set_direct_connectable() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x84, 0xFC, 8, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06]));
}
...
fn set_direct_connectable() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x84, 0xFC, 13, 0x00, 0x01, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x20, 0x00, 0x50,
        0x00
    ]));
}
...
fn set_io_capability() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x85, 0xFC, 1, 0x03]));
}
...
fn set_authentication_requirement() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x86, 0xFC, 26, 0x01, 0x01, 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8, 0x9, 0xA, 0xB,
        0xC, 0xD, 0xE, 0xF, 8, 64, 0, 0x40, 0xe2, 0x01, 0x00, 0x1
    ]));
}
...
fn set_authentication_requirement_2() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x86, 0xFC, 26, 0x00, 0x00, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
        0x0, 0x0, 0x0, 0x0, 1, 255, 1, 0x00, 0x00, 0x00, 0x00, 0x0
    ]));
}
...
fn set_authorization_requirement() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x87, 0xFC, 3, 0x01, 0x02, 0x01]));
}
...
fn pass_key_response() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x88, 0xFC, 6, 0x01, 0x02, 0x40, 0xe2, 0x01, 0x00]));
}
...
fn authorization_response() {
    let mut sink = RecordingSink::new();
    {
        ...
        fixture
            .act(|controller| {
                controller.authorization_response(
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x89, 0xFC, 3, 0x01, 0x02, 0x01]));
}
...
fn init() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8A, 0xFC, 1, 0x03]));
}
...
fn init() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8A, 0xFC, 3, 0x03, 0x01, 0x03]));
}
...
fn set_nonconnectable() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8B, 0xFC, 1, 0x02]));
}
...
fn set_nonconnectable() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8B, 0xFC, 2, 0x02, 0x02]));
}
...
fn set_undirected_connectable() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8C, 0xFC, 2, 0x00, 0x02]));
}
...
fn peripheral_security_request() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8D, 0xFC, 4, 0x01, 0x02, 0x01, 0x00]));
}
...
fn update_advertising_data() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8E, 0xFC, 4, 3, 1, 2, 3]));
}
...
fn delete_ad_type() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x8F, 0xFC, 1, 0x0A]));
}
...
fn set_event_mask() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x91, 0xFC, 2, 0x03, 0x00]));
}
...
fn configure_white_list() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x92, 0xFC, 0]));
}
...
fn terminate() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x93, 0xFC, 3, 0x01, 0x02, 0x05]));
}
...
fn clear_security_database() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x94, 0xFC, 0]));
}
...
fn allow_rebond() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x95, 0xFC, 0]));
}
...
fn allow_rebond() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x95, 0xFC, 2, 0x01, 0x02]));
}
...
fn start_limited_discovery_procedure() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x96, 0xFC, 6, 0x04, 0x00, 0x04, 0x00, 0x01, 0x01]));
}
...
fn start_general_discovery_procedure() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x97, 0xFC, 6, 0x04, 0x00, 0x04, 0x00, 0x01, 0x01]));
}
...
fn start_auto_connection_establishment() {
    let mut sink = RecordingSink::new();
    {
        ...
        fixture
            .act(|controller| {
                controller.start_auto_connection_establishment(
...
fn start_general_connection_establishment() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x9A, 0xFC, 6, 0x04, 0x00, 0x04, 0x00, 0x01, 0x1]));
}
...
fn start_selective_connection_establishment() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x9B, 0xFC, 22, 0x01, 0x04, 0x00, 0x04, 0x00, 0x01, 0x01, 0x02, 0x00, 1, 2, 3, 4, 5, 6,
        0x01, 6, 5, 4, 3, 2, 1
    ]));
}
...
fn create_connection() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x9C, 0xFC, 24, 0x04, 0x00, 0x04, 0x00, 0x00, 1, 2, 3, 4, 5, 6, 0x01, 0x28, 0x00, 0xc8,
        0x00, 10, 0, 0x58, 0x02, 0xF0, 0x00, 0x60, 0x09
    ]));
}
...
fn terminate_procedure() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x9D, 0xFC, 1, 0x01]));
}
...
fn terminate_multiple_procedure() {
    let mut sink = RecordingSink::new();
    {
        ...
        fixture
            .act(|controller| {
                controller
                    .terminate_procedure(Procedure::LIMITED_DISCOVERY | Procedure::OBSERVATION)
            })
            .unwrap();
    }
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x9D, 0xFC, 1, 0x81]));
}
...
fn start_connection_update() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[
        1, 0x9E, 0xFC, 14, 0x01, 0x02, 0x28, 0x00, 0xc8, 0x00, 10, 0, 0x58, 0x02, 0xF0, 0x00, 0x60,
        0x09
    ]));
}
...
fn send_pairing_request() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0x9F, 0xFC, 3, 0x01, 0x02, 0x03]));
}
...
fn get_bonded_devices() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0xA3, 0xFC, 0]));
}
...
fn start_observation_procedure() {
    ...
    assert!(sink.wrote_header());
    assert!(sink.wrote(&[1, 0xA2, 0xFC, 7, 0x04, 0x00, 0x04, 0x00, 0x00, 0x01, 0x01]));
}
...
fn is_device_bonded() {
    let mut sink = RecordingSink::new();
    {
        ...
        fixture
            .act(|controller| {
                controller.is_device_bonded(hci::host::PeerAddrType::PublicDeviceAddress(
